...
import { buildClientSchema, parse, print, visit, getIntrospectionQuery, } from 'graphql';
...
import { fetcherReturnToPromise, formatError, formatResult, isPromise, isObservable, isAsyncIterable, } from '@graphiql/toolkit';
                                ...
                                if (queryID === _this._editorQueryID) {
                                    ...
                                    if (maybeMultipart) {
                                        ...
                                        _this.setState({
                                            ...
                                            response: formatResult(fullResponse_1),
                                        });
                                    }
                                    else {
                                        var response_1 = formatResult(result);
    ...
    GraphiQL.prototype.fetchSchema = function () {
        ...
        fetch
            ...
            if (result && result.data && '__schema' in (result === null || result === void 0 ? void 0 : result.data)) {
                ...
                var responseString = typeof result === 'string' ? result : formatResult(result);
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 13:
                                            ...
                                            this.safeSetState({
                                                isWaitingForResponse: false,
                                                response: error_2 ? formatError(error_2) : undefined,
                                                subscription: null,
                                            });
                                            return [3, 14];
                                        case 14: return [2];
