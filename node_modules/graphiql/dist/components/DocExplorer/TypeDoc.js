...
var TypeDoc = (function (_super) {
    ...
    TypeDoc.prototype.render = function () {
        ...
        if (types && types.length > 0) {
            typesDef = (react_1.default.createElement("div", { id: "doc-types", className: "doc-category" },
        ...
        if (type && 'getFields' in type) {
            ...
            fieldsDef = (react_1.default.createElement("div", { id: "doc-fields", className: "doc-category" },
            ...
            if (deprecatedFields.length > 0) {
                deprecatedFieldsDef = (react_1.default.createElement("div", { id: "doc-deprecated-fields", className: "doc-category" },
...
function Field(_a) {
    ...
    return (react_1.default.createElement("div", { className: "doc-category-item" },
        ...
        'args' in field &&
            ...
            field.args.length > 0 && [
            '(',
            react_1.default.createElement("span", { key: "args" }, field.args
                .filter(function (arg) { return !arg.deprecationReason; })
                .map(function (arg) { return (react_1.default.createElement(Argument_1.default, { key: arg.name, arg: arg, onClickType: onClickType })); })),
            ')',
        ],
        ': ',
