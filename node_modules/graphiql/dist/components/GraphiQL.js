...
var GraphiQL = (function (_super) {
    ...
    function GraphiQL(props) {
                                ...
                                if (queryID === _this._editorQueryID) {
                                    ...
                                    if (maybeMultipart) {
                                        ...
                                        _this.setState({
                                            ...
                                            response: toolkit_1.formatResult(fullResponse_1),
                                        });
                                    }
                                    else {
                                        var response_1 = toolkit_1.formatResult(result);
        ...
        if (schema && !_this.props.dangerouslyAssumeSchemaIsValid) {
            ...
            if (validationErrors && validationErrors.length > 0) {
                response = toolkit_1.formatError(validationErrors);
                schema = undefined;
    ...
    GraphiQL.formatResult = function (result) {
        ...
        return toolkit_1.formatResult(result);
    };
    GraphiQL.formatError = function (error) {
        ...
        return toolkit_1.formatError(error);
    };
    ...
    GraphiQL.prototype.fetchSchema = function () {
        ...
        var fetch = toolkit_1.fetcherReturnToPromise(fetcher({
            query: this._introspectionQuery,
            operationName: this._introspectionQueryName,
        }, fetcherOpts));
        if (!toolkit_1.isPromise(fetch)) {
            this.setState({
        ...
        fetch
            ...
            var fetch2 = toolkit_1.fetcherReturnToPromise(fetcher({
            ...
            if (result && result.data && '__schema' in (result === null || result === void 0 ? void 0 : result.data)) {
                ...
                var responseString = typeof result === 'string' ? result : toolkit_1.formatResult(result);
    ...
    GraphiQL.prototype.handleSchemaErrors = function (schemaErrors) {
        this.safeSetState({
            response: schemaErrors ? toolkit_1.formatError(schemaErrors) : undefined,
            schema: undefined,
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                return [2, Promise.resolve(fetch)
                        .then(function (value) {
                        if (toolkit_1.isObservable(value)) {
                            var subscription = value.subscribe({
                                next: cb,
                                error: function (error) {
                                    _this.safeSetState({
                                        isWaitingForResponse: false,
                                        response: error ? toolkit_1.formatError(error) : undefined,
                                        subscription: null,
                                    });
                                },
                                complete: function () {
                        ...
                        else if (toolkit_1.isAsyncIterable(value)) {
                                ...
                                return __generator(this, function (_b) {
                                    switch (_b.label) {
                                        ...
                                        case 13:
                                            ...
                                            this.safeSetState({
                                                isWaitingForResponse: false,
                                                response: error_2 ? toolkit_1.formatError(error_2) : undefined,
                                                subscription: null,
                                            });
                                            return [3, 14];
                                        case 14: return [2];
